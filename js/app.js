(() => {
    ...
    function initSliders() {
        if (document.querySelector(".products__slider")) new core(".products__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".products__navigate-prev",
                nextEl: ".products__navigate-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".start-products__slider")) new core(".start-products__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".start-products__slider")) new core(".people-say__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
